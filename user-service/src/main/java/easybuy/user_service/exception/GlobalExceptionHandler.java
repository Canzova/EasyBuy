...
import easybuy.user_service.exception.customException.BadRequestException;
...
public class GlobalExceptionHandler {
    ...
    private ResponseEntity<ExceptionResponse> handleResourceNotFoundException(ResourceNotFoundException e, HttpServletRequest request) {
        return buildResponse(e.getMessage(), 404, HttpStatus.NOT_FOUND, request);
    }

    @ExceptionHandler(EmailAlreadyExistsException.class)
    private ResponseEntity<ExceptionResponse> handleEmailAlreadyExistsException(EmailAlreadyExistsException e, HttpServletRequest request) {
        return buildResponse(e.getMessage(), 409, HttpStatus.CONFLICT, request);
    }

    @ExceptionHandler(BadRequestException.class)
    private ResponseEntity<ExceptionResponse> handleBadRequestException(BadRequestException e, HttpServletRequest request) {
